...
%global docker_tag_fluentbit %{registry}/fluent-bit:v5.1.0
...
%changelog
* Mon Aug 17 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 3.10.0-1
