...
%global docker_tag_fluentbit %{registry}/fluent-bit:v3.1.9
...
%changelog
* Thu Dec 04 2025 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 3.5.0-1
