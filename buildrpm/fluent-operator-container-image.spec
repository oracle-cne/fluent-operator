...
%global docker_tag_fluentbit %{registry}/fluent-bit:v4.2.7
...
%changelog
* Tue Jun 09 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 3.9.0-1
